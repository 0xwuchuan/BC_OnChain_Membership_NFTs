...
contract NUSFintechieRenderer is INUSFintechieRenderer {
    ...
    // color  (hex)   (binary)                   << 8(unused) + 24 bits * index
    // ====================================================================================
    // blue   #3E7FED (001111100111111111101101) << 32                  * 5
    // red    #EC5B5B (111011000101101101011011) << 32                  * 4
    // green  #83C282 (100000111100001010000010) << 32                  * 3
    // yellow #FDC63A (111111011100011000111010) << 32                  * 2
    // orange #FD973A (111111011001011100111010) << 32                  * 1
    // purple #B954F7 (101110010101010011110111) << 32                  * 0
    ...
    /// @inheritdoc INUSFintechieRenderer
    /// @dev role is used to determine hat (0-indexed)
    function render(uint256 _seed, uint256 _role) external pure returns (string memory) {
        Fintechie memory fintechie;

        // Select characters for fintechie's different traits using bit manipulation
        fintechie.hat = uint8(_role);
